...
export const AppsProducts = () => {
  ...
  return (
    <Section
      ...
      title={{ text: "apps.products.title" }}
      description={{ text: "apps.products.description" }}
    >
      <ul className="apps-products__grid">
        {Config.apps.products.map(
          ({ id, href, status, statusKey, titleKey, descriptionKey }) => (
            <li key={id} className="apps-products__card">
              ...
              <h3 className="apps-products__card-title">{t(titleKey)}</h3>
